...
module find_errors(                         // line 1
  input [0:3] a,                             // line 2 (added data type for 
  output [3:0] b,                            // line 3
  input [5:0] c);                            // line 4
                                             // line 5
  		                            // line 6
  ...
  wire [5:0] creg;                            // line 8
	                                     // line 9
  		                            // line 10
  assign b = bw;                             // line 11 (changed assignment order)
  assign creg = c;                           // line 12
always @(*)                       // line 13 (added sensitivity list)
  begin                                      // line 14
    if (creg == 6'b111111)   //creg is all 1s   
       bw <= a;                             // line 16  
    else                                     // line 17
     bw <= 4'b0101;                          // line 18
end  
	                                     // line 19 (added missing 'end')
endmodule                                   // line 20
